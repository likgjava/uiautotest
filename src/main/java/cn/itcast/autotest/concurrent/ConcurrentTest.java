...
public class ConcurrentTest {
    ...
    public void test(String name, String password, String udid, int port) throws Exception {
        System.out.println("username=" + name + "port=" + port + " thread=" + Thread.currentThread().getId());
